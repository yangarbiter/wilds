...
python examples/run_expt.py \
  ...
  --uniform_iid --sample_rate 0.0005 \
  --log_dir ./logs/${DATASET}/erm-dpsgd_1e-5_1.0_1.0_0.0005 \
...
#  --uniform_iid --sample_rate 0.0005 \
#  --log_dir ./logs/${DATASET}/erm-dpsgd_1e-5_2.0_1.0_0.0005 \
#  --algorithm ERM

#python examples/run_expt.py \
#  --dataset $DATASET --model $MODEL --n_epochs $EPOCHS --batch_size $BATCHSIZE --root_dir $ROOTDIR \
#  --optimizer DPSGD --delta 1e-5 --sigma 1.0 --max_per_sample_grad_norm 1.0 \
#  --weighted_uniform_iid --sample_rate 0.0005 \
#  --log_dir ./logs/${DATASET}/erm-dpsgd_1e-5_1.0_1.0_0.0005 \
#  --algorithm ERM
